    ...
    A: apis::EventDispatcher + apis::default::Default,
{
    ...
    if let Ok(resp) = resp.as_ref() {
        if !event.is_empty() {
            ...
            event.insert(
                event::convention::EVENT_ACTION.to_string(),
                "callback_with_header_post".to_string(),
            );
            api_impl.as_ref().dispatch(event).await;
        }
    }
    ...
    A: apis::EventDispatcher + apis::default::Default,
{
    ...
    if let Ok(resp) = resp.as_ref() {
        if !event.is_empty() {
            ...
            event.insert(
                event::convention::EVENT_ACTION.to_string(),
                "complex_query_param_get".to_string(),
            );
            api_impl.as_ref().dispatch(event).await;
        }
    }
    ...
    A: apis::EventDispatcher + apis::default::Default,
{
    ...
    if let Ok(resp) = resp.as_ref() {
        if !event.is_empty() {
            ...
            event.insert(
                event::convention::EVENT_ACTION.to_string(),
                "enum_in_path_path_param_get".to_string(),
            );
            api_impl.as_ref().dispatch(event).await;
        }
    }
    ...
    A: apis::EventDispatcher + apis::default::Default,
{
    ...
    if let Ok(resp) = resp.as_ref() {
        if !event.is_empty() {
            ...
            event.insert(
                event::convention::EVENT_ACTION.to_string(),
                "get_with_boolean_parameter".to_string(),
            );
            api_impl.as_ref().dispatch(event).await;
        }
    }
    ...
    A: apis::EventDispatcher + apis::default::Default,
{
    ...
    if let Ok(resp) = resp.as_ref() {
        if !event.is_empty() {
            ...
            event.insert(
                event::convention::EVENT_ACTION.to_string(),
                "json_complex_query_param_get".to_string(),
            );
            api_impl.as_ref().dispatch(event).await;
        }
    }
    ...
    A: apis::EventDispatcher + apis::default::Default,
{
        ...
        let header_x_header = match header_x_header {
            Some(v) => match header::IntoHeaderValue::<String>::try_from((*v).clone()) {
                ...
                Err(err) => {
                    return Response::builder()
                        .status(StatusCode::BAD_REQUEST)
                        .body(Body::from(format!(r#"Invalid header X-Header - {err}"#)))
                        .map_err(|e| {
                            error!(error = ?e);
                            StatusCode::INTERNAL_SERVER_ERROR
                        });
    ...
    if let Ok(resp) = resp.as_ref() {
        if !event.is_empty() {
            ...
            event.insert(
                event::convention::EVENT_ACTION.to_string(),
                "mandatory_request_header_get".to_string(),
            );
            api_impl.as_ref().dispatch(event).await;
        }
    }
    ...
    A: apis::EventDispatcher + apis::default::Default,
{
    ...
    if let Ok(resp) = resp.as_ref() {
        if !event.is_empty() {
            ...
            event.insert(
                event::convention::EVENT_ACTION.to_string(),
                "merge_patch_json_get".to_string(),
            );
            api_impl.as_ref().dispatch(event).await;
        }
    }
    ...
    A: apis::EventDispatcher + apis::default::Default,
{
    ...
    if let Ok(resp) = resp.as_ref() {
        if !event.is_empty() {
            ...
            event.insert(
                event::convention::EVENT_ACTION.to_string(),
                "multiple_auth_scheme_get".to_string(),
            );
            api_impl.as_ref().dispatch(event).await;
        }
    }
    ...
    A: apis::EventDispatcher + apis::default::Default,
{
    ...
    if let Ok(resp) = resp.as_ref() {
        if !event.is_empty() {
            ...
            event.insert(
                event::convention::EVENT_ACTION.to_string(),
                "readonly_auth_scheme_get".to_string(),
            );
            api_impl.as_ref().dispatch(event).await;
        }
    }
    ...
    A: apis::EventDispatcher + apis::default::Default,
{
    ...
    if let Ok(resp) = resp.as_ref() {
        if !event.is_empty() {
            ...
            event.insert(
                event::convention::EVENT_ACTION.to_string(),
                "register_callback_post".to_string(),
            );
            api_impl.as_ref().dispatch(event).await;
        }
    }
    ...
    A: apis::EventDispatcher + apis::default::Default,
{
    ...
    if let Ok(resp) = resp.as_ref() {
        if !event.is_empty() {
            ...
            event.insert(
                event::convention::EVENT_ACTION.to_string(),
                "required_octet_stream_put".to_string(),
            );
            api_impl.as_ref().dispatch(event).await;
        }
    }
    ...
    A: apis::EventDispatcher + apis::default::Default,
{
            ...
            apis::default::ResponsesWithHeadersGetResponse::Status200_Success {
                ...
                let success_info = match header::IntoHeaderValue(success_info).try_into() {
                    ...
                    Err(e) => {
                        return Response::builder()
                                                                    .status(StatusCode::INTERNAL_SERVER_ERROR)
                                                                    .body(Body::from(format!(r#"An internal server error occurred handling success_info header - {e}"#))).map_err(|e| { error!(error = ?e); StatusCode::INTERNAL_SERVER_ERROR });
                    }
                };
                ...
                if let Some(bool_header) = bool_header {
                    let bool_header = match header::IntoHeaderValue(bool_header).try_into() {
                        ...
                        Err(e) => {
                            return Response::builder()
                                                                    .status(StatusCode::INTERNAL_SERVER_ERROR)
                                                                    .body(Body::from(format!(r#"An internal server error occurred handling bool_header header - {e}"#))).map_err(|e| { error!(error = ?e); StatusCode::INTERNAL_SERVER_ERROR });
                        }
                    };
                ...
                if let Some(object_header) = object_header {
                    let object_header = match header::IntoHeaderValue(object_header).try_into() {
                        ...
                        Err(e) => {
                            return Response::builder()
                                                                    .status(StatusCode::INTERNAL_SERVER_ERROR)
                                                                    .body(Body::from(format!(r#"An internal server error occurred handling object_header header - {e}"#))).map_err(|e| { error!(error = ?e); StatusCode::INTERNAL_SERVER_ERROR });
                        }
                    };
                ...
                if let Some(further_info) = further_info {
                    let further_info = match header::IntoHeaderValue(further_info).try_into() {
                        ...
                        Err(e) => {
                            return Response::builder()
                                                                    .status(StatusCode::INTERNAL_SERVER_ERROR)
                                                                    .body(Body::from(format!(r#"An internal server error occurred handling further_info header - {e}"#))).map_err(|e| { error!(error = ?e); StatusCode::INTERNAL_SERVER_ERROR });
                        }
                    };
                ...
                if let Some(failure_info) = failure_info {
                    let failure_info = match header::IntoHeaderValue(failure_info).try_into() {
                        ...
                        Err(e) => {
                            return Response::builder()
                                                                    .status(StatusCode::INTERNAL_SERVER_ERROR)
                                                                    .body(Body::from(format!(r#"An internal server error occurred handling failure_info header - {e}"#))).map_err(|e| { error!(error = ?e); StatusCode::INTERNAL_SERVER_ERROR });
                        }
                    };
    ...
    if let Ok(resp) = resp.as_ref() {
        if !event.is_empty() {
            ...
            event.insert(
                event::convention::EVENT_ACTION.to_string(),
                "responses_with_headers_get".to_string(),
            );
            api_impl.as_ref().dispatch(event).await;
        }
    }
    ...
    A: apis::EventDispatcher + apis::default::Default,
{
                ...
                Err(err) => {
                    return Response::builder()
                        ...
                        .body(Body::from(format!(
                            r#"Invalid header x-header-one - {err}"#
                        )))
                        .map_err(|e| {
                            error!(error = ?e);
                            StatusCode::INTERNAL_SERVER_ERROR
            ...
            Some(v) => match header::IntoHeaderValue::<bool>::try_from((*v).clone()) {
                ...
                Err(err) => {
                    return Response::builder()
                        .status(StatusCode::BAD_REQUEST)
                        .body(Body::from(format!(
                            r#"Invalid header x-header-two - {err}"#
                        )))
                        .map_err(|e| {
                            error!(error = ?e);
                            StatusCode::INTERNAL_SERVER_ERROR
    ...
    if let Ok(resp) = resp.as_ref() {
        if !event.is_empty() {
            ...
            event.insert(
                event::convention::EVENT_ACTION.to_string(),
                "two_first_letter_headers".to_string(),
            );
            api_impl.as_ref().dispatch(event).await;
        }
    }
    ...
    A: apis::EventDispatcher + apis::default::Default,
{
    ...
    if let Ok(resp) = resp.as_ref() {
        if !event.is_empty() {
            ...
            event.insert(
                event::convention::EVENT_ACTION.to_string(),
                "untyped_property_get".to_string(),
            );
            api_impl.as_ref().dispatch(event).await;
        }
    }
