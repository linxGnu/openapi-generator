...
This autogenerated project defines an API crate `rust-axum-test` which contains:
...
#[async_trait]
impl rust-axum-test::Api for ServerImpl {
...
pub async fn start_server(addr: &str) {
    ...
    let api_impl = Arc::new(ServerImpl);

    let app = apis::server::new(api_impl);
